...
void CloudProjection::FixDepthSystematicErrorIfNeeded() {
  ...
  // std::cout<<_corrections.size()<<"  "<<_depth_image.rows<<std::endl;
...
const cv::Mat& CloudProjection::intensity_image() const {
  return this->_intensity_image;
}

const cv::Mat& CloudProjection::row_angle_image() const {
  return this->_row_angle_image;
}

const cv::Mat& CloudProjection::col_angle_image() const {
  return this->_col_angle_image;
}

cv::Mat& CloudProjection::depth_image() { return this->_depth_image; }

cv::Mat& CloudProjection::intensity_image() { return this->_intensity_image; }

cv::Mat& CloudProjection::row_angle_image() { return this->_row_angle_image; }

cv::Mat& CloudProjection::col_angle_image() { return this->_col_angle_image; }
