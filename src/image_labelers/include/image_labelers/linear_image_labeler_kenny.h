...
#ifndef IMAGE_LABELERS_LINEAR_IMAGE_LABELER_H
#define IMAGE_LABELERS_LINEAR_IMAGE_LABELER_H
...
class LinearImageLabeler : public AbstractImageLabeler {
 public:
  ...
  static constexpr int16_t NEIGH_SIZE = 1;
  ...
  {
    Radians _near_ground_threshold = 15_deg;
